import { BepBackground, InteractiveTitle } from "./bep-background";

export default function Home() {
  return (
    <div className="relative flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black overflow-hidden select-none">
      <BepBackground />
      <div className="relative z-10 flex flex-col items-center pointer-events-none">
        <InteractiveTitle />
        <p className="mt-2 text-lg font-normal leading-7 tracking-tight text-black dark:text-zinc-50">maksim6opka</p>
      ...
      <a
        ...
        className="absolute bottom-8 z-20 text-black transition-transform hover:scale-110 dark:text-zinc-50"
      >
